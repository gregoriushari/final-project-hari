            ...
            <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="memori_kriteria_name">Memory Storage</label>
                        <input type="text" class="form-control" value="<?= old('name');?>" name="name" id="name" >
                    </div>
                    <div class="form-group">
                        <label for="memori_kriteria_bobot">Bobot</label>
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/memori/edit/'.$memoris['memori_kriteria_id']); ?>"  method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="memori_kriteria_name">Memory Storage</label>
                            <input type="text" class="form-control" value="<?= $memoris['memori_kriteria_name'] ?>" id="name" name="name" >
                        </div>
                        <div class="form-group">
                            <label for="memori_kriteria_bobot">Bobot</label>
                            <input type="number" class="form-control" value="<?= $memoris['memori_kriteria_bobot'] ?>" id="bobot" name="bobot" >
                        </div>
                    </div>
                    <div class="modal-footer">
