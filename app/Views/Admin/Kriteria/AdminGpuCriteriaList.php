            ...
            <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" id="name" placeholder="GPU Type">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/gpu/edit/'.$gpus['gpu_kriteria_id']); ?>"  method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?= $gpus['gpu_kriteria_name'] ?>" id="name" name="name" placeholder="Ram Capacity">
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-control" value="<?= $gpus['gpu_kriteria_bobot'] ?>" id="bobot" name="bobot" placeholder="Bobot">
                        </div>
                    </div>
                    <div class="modal-footer">
