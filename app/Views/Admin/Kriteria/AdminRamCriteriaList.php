...
<div>
  <table id="table_id" class="display">
      ...
      <?php foreach($ram as $rams): ?>
          <tr>
            <th scope="row"><?= $i; ?></th>
            <td><?= $rams['ram_kriteria_name']; ?></td>
            <td><?= $rams['ram_kriteria_bobot']; ?></td>
...
<!-- Modal -->
<div class="modal fade" id="newRamModal" tabindex="-1" role="dialog" aria-labelledby="newRamModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newRAMModalLabel">Add RAM Criteria</h5>
...
<?php foreach ($ram as $rams) : ?>
    <div class="modal fade" id="editRAM<?= $rams['ram_kriteria_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editRAM<?= $rams['ram_kriteria_id'] ?>Label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editRAM<?= $rams['ram_kriteria_id'] ?>Label">Edit RAM Capacity</h5>
